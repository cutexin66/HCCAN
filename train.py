...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--output_dir', default='./outputs/refcoco_r50',
    ...
    parser.add_argument('--detr_model', default='./checkpoints/detr-r50-unc.pth', type=str, help='detr model')
