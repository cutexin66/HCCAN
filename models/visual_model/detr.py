...
class DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor,textguid):
        ...
        if self.transformer is not None:
            out = self.transformer(self.input_proj(src), textguid, mask, pos[-1], query_embed=None)
        else:
