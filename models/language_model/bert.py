...
class BERT(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor,out=False):
        if out is False:
            if self.enc_num > 0:
                ...
                xs1 = all_encoder_layers[7]
                xs2 = all_encoder_layers[3]
                xs=(xs+xs1+xs2)/3
            else:
            ...
            if self.enc_num > 0:
                all_encoder_layers, _ = self.bert(tensor_list.tensors, token_type_ids=None,
